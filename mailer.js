      ...
      <tr><td align="center">
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;background:#fffdf9;border:1px solid #ded8cc;">
          ...
          <tr><td style="padding:28px 32px;">
            ...
            <p style="margin:0 0 24px;color:#64717a;font-size:14px;line-height:1.6;">Apresente este QR Code na recepção do CENFORPE. O código backup abaixo serve como alternativa caso a leitura não funcione.</p>
          ...
          <tr><td style="padding:22px 32px;background:#0c2032;color:#d9dfdc;font-size:12px;line-height:1.6;">03 de setembro de 2026 · a partir das 9h<br>CENFORPE · São Bernardo do Campo<br><span style="color:#ead4a0;">Evento gratuito · vagas limitadas</span></td></tr>
        </table>
      </td></tr>
    </table>
  </body>
...
function receiptText(lead) {
  return [
    ...
    'CENFORPE · São Bernardo do Campo',
    '',
